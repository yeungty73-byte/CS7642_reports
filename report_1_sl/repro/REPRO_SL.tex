...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{Stage 2 (held-out test split).} A second
        \texttt{StratifiedShuffleSplit(n\_splits=1, test\_size=0.20,
        random\_state=7641)} on the 20{,}000-row sample produces a
        16{,}000-row training partition and a 4{,}000-row test partition,
